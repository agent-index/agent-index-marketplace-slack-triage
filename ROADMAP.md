...
v1.0 focuses narrowly on **response debt** — finding messages that are waiting for the member's reply and surfacing them with urgency context. The collection covers DMs, @mentions, thread follow-ups, and directed questions in monitored channels. It includes the standard training loop for iterative accuracy improvement.
